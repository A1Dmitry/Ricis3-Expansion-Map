...
- 📋 **Официальный реестр внедрений и адаптеров**: [`adopters.md`](https://github.com/A1Dmitry/RICIS-III-Lean4-Kernel/blob/main/adopters.md)
...
Оригинальный реестр экосистемы поддерживается в репозитории ядра:
👉 [**https://github.com/A1Dmitry/RICIS-III-Lean4-Kernel/blob/main/adopters.md**](https://github.com/A1Dmitry/RICIS-III-Lean4-Kernel/blob/main/adopters.md)
...
### Downstream масштабная интеграция: Formalization of Fermat's Last Theorem (Anthropic, Август 2026)
Репозиторий [`anthropics/fermats-last-theorem`](https://github.com/anthropics/fermats-last-theorem) продемонстрировал практическую силу методологии автономной декомпозиции формальных доказательств в иерархический граф лемм (Blueprint DAG) с автономным Web-инспектором (директория `html/`). Безлимитная редукция узлов AST, типизированные нули и сохранение провенанса операндов обеспечивают устойчивость автоматических пруверов при устранении аналитических сингулярностей в Lean 4.
