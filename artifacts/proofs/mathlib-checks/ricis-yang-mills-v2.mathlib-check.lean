...
/-! ===== GENERATED KERNEL-CHECK EPILOGUE (mathlib, additive only) =====
  ...
  Source      : artifacts/proofs/ricis-yang-mills-v2.lean
  Source hash : sha256 cfac8b97f3051366b77b6fe09ab92c02d674861b5c5f42b408e647f1631579bf
  ...
  Basis       : НОВАЯ версия внешнего артефакта ricis-yang-mills.lean (TASK-02 / F-14): импорт несуществующего в закреплённой ревизии Mathlib модуля Mathlib.Basic.Real.Basic заменён на существующий Mathlib.Data.Real.Basic; тела доказательств сохранены, вводящие в заблуждение имена теорем заменены описательными (skew_product_orthogonal_pair_eq_div и т. д.). Тело действительно нуждается в Mathlib: ℝ и тактика ring. До фактического прогона компилируемость — UNVERIFIED_PREDICTION (правило TASK-07); статус записывает реестр, а не шапка файла.
  ...
  ============================================================================-/
#print axioms RICIS.skew_product_orthogonal_pair_eq_div
#print axioms RICIS.skew_product_conjugate_pair_eq_square
#print axioms RICIS.orthogonal_bridge_invariant_eq_div
