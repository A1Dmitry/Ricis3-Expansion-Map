...
/-! ===== GENERATED KERNEL-CHECK EPILOGUE (additive only) =====
  ...
  Source      : artifacts/proofs/database-a6-0_5_inf_3.standalone.lean
  Source hash : sha256 963f701f3c87f7994f3784944250b46df5026e71be4ae8279bf41cf4d4e99d2c
  ...
  Basis       : Тело: типизированное ядро RICIS3.ExtendedKernel (RExpr/Rewrite/Derivation) и адаптер сгенерированного утверждения 0_5 × ∞_3. Использованы только abbrev/inductive/structure/deriving и тактики exact / constructor / intro / simpa (simpa — core-тактика 4.33.1).
...
#print axioms RICIS3.GeneratedDatabaseProof.generated_claim_is_a6_bridge
#print axioms RICIS3.GeneratedDatabaseProof.generated_claim_indices_are_finite
