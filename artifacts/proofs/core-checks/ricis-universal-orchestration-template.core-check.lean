...
/-! ===== GENERATED KERNEL-CHECK EPILOGUE (additive only) =====
  ...
  Source      : artifacts/proofs/ricis-universal-orchestration-template.lean
  Source hash : sha256 cebe44f3e058d6d68b9b6df267300162aa53d4ce5730e3e98d623991a4363849
  ...
  Basis       : Тело: структурные редукции, счетчики `Nat`, доказательство-конъюнкция закрыто ⟨rfl, …⟩. Mathlib-символов нет — проверено фактическим прогоном ядра (run 34858902595, exit 0).
  ...
  ============================================================================-/
#print axioms RICIS_Template.L1_identity
#print axioms RICIS_Template.divSelf_one
#print axioms RICIS_Template.SP2_subSelf_zero
#print axioms RICIS_Template.A1_div_zero
#print axioms RICIS_Template.A2_inf_zero_one
#print axioms RICIS_Template.zero_div_zero_step1
#print axioms RICIS_Template.zero_div_zero_step2
#print axioms RICIS_Template.zero_div_zero_one
#print axioms RICIS_Template.A4_indexed_zero_div
#print axioms RICIS_Template.A5_inf_div
#print axioms RICIS_Template.A6_geometric_realization
#print axioms RICIS_Template.A7_inf_sub
#print axioms RICIS_Template.A10_mul_zero
#print axioms RICIS_Template.A10_zero_mul
#print axioms RICIS_Template.L0_continuity_divSelf
#print axioms RICIS_Template.L0_continuity_subSelf
#print axioms RICIS_Template.L0_continuity_A6_rect
#print axioms RICIS_Template.L0_continuity_A6_measure
#print axioms RICIS_Template.SP4_preserves_parent
#print axioms RICIS_Template.mySystem_4D_resolved
#print axioms RICIS_Template.L0_mySystem_no_discontinuity
#print axioms RICIS_Template.mySystem_steps_4D
#print axioms RICIS_Template.mySystem_error_zero
#print axioms RICIS_Template.CPU_CUDA_same
#print axioms RICIS_Template.complex_divSelf_one
#print axioms RICIS_Template.complex_subSelf_zero
#print axioms RICIS_Template.RICIS_unified
