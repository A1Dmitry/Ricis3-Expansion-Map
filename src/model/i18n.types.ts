...
export const DICTIONARY = {
  ...
  // Map presentation, source-bound catalogue and guided trail chrome
  'map.roadmap.aria': { ru: 'Открыть Roadmap', en: 'Open roadmap' },
  'map.roadmap.title': { ru: 'Выбрать маршрут исследования', en: 'Choose research route' },
  'map.voynich.label': { ru: 'Войнич EVA ($50Т)', en: 'Voynich EVA ($50T)' },
  'map.voynich.title': { ru: 'Дешифровка Рукописи Войнича EVA Genome (DOI 10.5281/zenodo.18001299)', en: 'Voynich Manuscript EVA Genome decipherment (DOI 10.5281/zenodo.18001299)' },
  'map.presentation.list': { ru: 'Режим списка', en: 'List mode' },
  'map.presentation.threeDimensional': { ru: '3D-карта', en: '3D map' },
  'map.presentation.toggle': { ru: 'Переключить между 3D-картой и доступным списком', en: 'Switch between 3D map and accessible list' },
  'map.selectedProblem': { ru: 'Выбранная задача', en: 'Selected problem' },
  'map.nodeCard': { ru: 'Карточка узла', en: 'Node card' },
  'calculatorExplorer.action': { ru: 'Решенные случаи калькулятора', en: 'Solved Calculator Cases' },
  'calculatorExplorer.title': { ru: 'Решенные случаи калькулятора', en: 'Solved Calculator Cases' },
  'calculatorExplorer.subtitle': { ru: 'Источник-обусловленный каталог. Выбор открывает существующий узел карты и не запускает расчёт.', en: 'Source-bound catalogue. Selection opens an existing map node and does not run a calculation.' },
  'calculatorExplorer.close': { ru: 'Закрыть каталог калькулятора', en: 'Close calculator catalogue' },
  'calculatorExplorer.open': { ru: 'Открыть {title}', en: 'Open {title}' },
  'calculatorExplorer.unconfigured': { ru: 'Visual calculator не настроен: {reason}', en: 'Visual calculator is not configured: {reason}' },
  'calculatorExplorer.rejected': { ru: 'Visual calculator недоступен: {reason}', en: 'Visual calculator is unavailable: {reason}' },
  'guidedTrail.action': { ru: 'Маршрут изучения мономолитов', en: 'Monolith Learning Trail' },
  'guidedTrail.label': { ru: 'Маршрут изучения мономолитов', en: 'Monolith learning trail' },
  'guidedTrail.title': { ru: 'Маршрут изучения мономолитов', en: 'Monolith Learning Trail' },
  'guidedTrail.subtitle': { ru: 'Источник-обусловленный маршрут по опубликованным случаям: только чтение и навигация по существующим узлам.', en: 'Source-bound route through published cases: read-only navigation across existing nodes.' },
  'guidedTrail.close': { ru: 'Закрыть маршрут изучения', en: 'Close learning trail' },
  'guidedTrail.educationalDisclosure': { ru: 'Маршрут является source-bound учебной навигацией: не является запуском calculator, не создаёт Core/Lean result, proof, trust, state или authority decision и не выполняет внешнее действие.', en: 'This route is source-bound learning navigation: it does not run a calculator, create a Core/Lean result, proof, trust, state or authority decision, or perform an external action.' },
  'guidedTrail.initialAnchor': { ru: 'Начальная точка изучения', en: 'Learning starting point' },
  'guidedTrail.semanticIndex': { ru: 'Семантический индекс', en: 'Semantic index' },
  'guidedTrail.structuralResult': { ru: 'Структурный результат', en: 'Structural result' },
  'guidedTrail.open': { ru: 'Открыть {title}', en: 'Open {title}' },
  'guidedTrail.follow': { ru: 'Следовать к {title}', en: 'Follow to {title}' },
