...
export const LOCALE_OVERRIDES: Partial<Record<TranslationKey, LocaleOverride>> = {
  ...
  'agentLog.title': {
    'fr-CA': 'Journal d’activité de l’agent IA',
    'de-DE': 'Aktivitätsprotokoll des KI-Agenten',
    'hi-IN': 'एआई एजेंट गतिविधि लॉग',
    'ms-MY': 'Log aktiviti ejen AI',
  },
  'agentLog.close': {
    'fr-CA': 'Fermer le journal de l’agent',
    'de-DE': 'Agentenprotokoll schließen',
    'hi-IN': 'एजेंट लॉग बंद करें',
    'ms-MY': 'Tutup log ejen',
  },
  'agentLog.filter.all': {
    'fr-CA': 'Tous ({count})',
    'de-DE': 'Alle ({count})',
  ...
  'agentLog.search.placeholder': {
    'fr-CA': 'Filtrer les messages...',
    'de-DE': 'Nachrichten filtern...',
    'hi-IN': 'संदेश फ़िल्टर करें...',
    'ms-MY': 'Tapis mesej...',
  },
  'agentLog.autoScroll': {
    'fr-CA': 'Défilement automatique',
    'de-DE': 'Automatisch scrollen',
    'hi-IN': 'स्वतः स्क्रॉल',
    'ms-MY': 'Tatal automatik',
  },
  'agentLog.copy': {
    'fr-CA': '📋 Copier',
    'de-DE': '📋 Kopieren',
  ...
  'agentLog.copy.title': {
    'fr-CA': 'Copier les journaux affichés',
    'de-DE': 'Sichtbare Protokolle kopieren',
    'hi-IN': 'दिखाए गए लॉग कॉपी करें',
    'ms-MY': 'Salin log yang dipaparkan',
  },
  'agentLog.clear': {
    'fr-CA': 'Effacer le journal',
    'de-DE': 'Protokoll leeren',
    'hi-IN': 'लॉग साफ़ करें',
    'ms-MY': 'Kosongkan log',
  },
  'agentLog.empty': {
    'fr-CA': 'Aucune entrée de journal ne correspond au filtre sélectionné.',
    'de-DE': 'Keine Protokolleinträge entsprechen dem ausgewählten Filter.',
    'hi-IN': 'चुने गए फ़िल्टर से कोई लॉग प्रविष्टि मेल नहीं खाती।',
    'ms-MY': 'Tiada entri log sepadan dengan penapis yang dipilih.',
  },
  'agentLog.nodeLink': {
    'fr-CA': 'Accéder au nœud',
    'de-DE': 'Zum Knoten',
    'hi-IN': 'नोड पर जाएँ',
    'ms-MY': 'Pergi ke nod',
  },
  'agentLog.total': {
    'fr-CA': 'Total des entrées : {count}',
    'de-DE': 'Einträge insgesamt: {count}',
    'hi-IN': 'कुल प्रविष्टियाँ: {count}',
    'ms-MY': 'Jumlah entri: {count}',
  },
  'agentLog.footerHint': {
    'fr-CA': 'Cliquez sur un horodatage ou la flèche de la barre d’état inférieure pour un accès rapide',
    'de-DE': 'Klicken Sie für den Schnellzugriff auf einen Zeitstempel oder den Pfeil in der unteren Statusleiste',
    'hi-IN': 'त्वरित पहुँच के लिए समय-चिह्न या निचली स्थिति पट्टी में तीर पर क्लिक करें',
    'ms-MY': 'Klik cap masa atau anak panah pada bar status bawah untuk akses pantas',
  },
  'agentLog.clipboard.details': {
    'fr-CA': 'Détails : {details}',
    'de-DE': 'Details: {details}',
    'hi-IN': 'विवरण: {details}',
    'ms-MY': 'Butiran: {details}',
  },
  'map.roadmap.aria': {
    'fr-CA': 'Ouvrir la feuille de route',
    'de-DE': 'Roadmap öffnen',
    'hi-IN': 'रोडमैप खोलें',
    'ms-MY': 'Buka peta jalan',
  },
  'map.roadmap.title': {
    'fr-CA': 'Choisir un itinéraire de recherche',
    'de-DE': 'Forschungsroute wählen',
    'hi-IN': 'अनुसंधान मार्ग चुनें',
    'ms-MY': 'Pilih laluan penyelidikan',
  },
  'map.voynich.label': {
    'fr-CA': 'Voynich EVA (50\u00A0k$)',
    'de-DE': 'Voynich EVA (50\u00A0k$)',
    'hi-IN': 'Voynich EVA ($50T)',
    'ms-MY': 'Voynich EVA ($50T)',
  },
  'map.voynich.title': {
    'fr-CA': 'Déchiffrement du génome EVA du manuscrit de Voynich (DOI 10.5281/zenodo.18001299)',
    'de-DE': 'Entschlüsselung des Voynich-Manuskripts EVA-Genom (DOI 10.5281/zenodo.18001299)',
    'hi-IN': 'Voynich पांडुलिपि EVA जीनोम व्याख्या (DOI 10.5281/zenodo.18001299)',
    'ms-MY': 'Penyahkodan genom EVA Manuskrip Voynich (DOI 10.5281/zenodo.18001299)',
  },
  'map.presentation.list': {
    'fr-CA': 'Mode liste',
    'de-DE': 'Listenansicht',
    'hi-IN': 'सूची मोड',
    'ms-MY': 'Mod senarai',
  },
  'map.presentation.threeDimensional': {
    'fr-CA': 'Carte 3D',
    'de-DE': '3D-Karte',
    'hi-IN': '3D मानचित्र',
    'ms-MY': 'Peta 3D',
  ...
  'map.presentation.toggle': {
    'fr-CA': 'Basculer entre la carte 3D et la liste accessible',
    'de-DE': 'Zwischen 3D-Karte und barrierefreier Liste wechseln',
    'hi-IN': '3D मानचित्र और सुलभ सूची के बीच स्विच करें',
    'ms-MY': 'Beralih antara peta 3D dan senarai boleh capai',
  },
  'map.selectedProblem': {
    'fr-CA': 'Problème sélectionné',
    'de-DE': 'Ausgewähltes Problem',
    'hi-IN': 'चयनित समस्या',
    'ms-MY': 'Masalah dipilih',
  },
  'map.nodeCard': {
    'fr-CA': 'Fiche du nœud',
    'de-DE': 'Knotenkarte',
  ...
  'calculatorExplorer.action': {
    'fr-CA': 'Cas résolus du calculateur',
    'de-DE': 'Gelöste Rechnerfälle',
    'hi-IN': 'हल किए गए कैलकुलेटर केस',
    'ms-MY': 'Kes kalkulator diselesaikan',
  },
  'calculatorExplorer.title': {
    'fr-CA': 'Cas résolus du calculateur',
    'de-DE': 'Gelöste Rechnerfälle',
    'hi-IN': 'हल किए गए कैलकुलेटर केस',
    'ms-MY': 'Kes kalkulator diselesaikan',
  },
  'calculatorExplorer.subtitle': {
    'fr-CA': 'Catalogue lié à la source. La sélection ouvre un nœud de carte existant et ne lance pas de calcul.',
    'de-DE': 'Quellengebundener Katalog. Die Auswahl öffnet einen vorhandenen Karteneintrag und startet keine Berechnung.',
    'hi-IN': 'स्रोत-बद्ध कैटलॉग। चयन एक मौजूदा मानचित्र नोड खोलता है और गणना नहीं चलाता।',
    'ms-MY': 'Katalog terikat sumber. Pilihan membuka nod peta sedia ada dan tidak menjalankan pengiraan.',
  },
  'calculatorExplorer.close': {
    'fr-CA': 'Fermer le catalogue du calculateur',
    'de-DE': 'Rechnerkatalog schließen',
    'hi-IN': 'कैलकुलेटर कैटलॉग बंद करें',
    'ms-MY': 'Tutup katalog kalkulator',
  },
  'calculatorExplorer.open': {
    'fr-CA': 'Ouvrir {title}',
    'de-DE': '{title} öffnen',
    'hi-IN': '{title} खोलें',
    'ms-MY': 'Buka {title}',
  },
  'calculatorExplorer.unconfigured': {
    'fr-CA': 'Le calculateur visuel n\'est pas configuré\u00A0: {reason}',
    'de-DE': 'Der visuelle Rechner ist nicht konfiguriert: {reason}',
    'hi-IN': 'विज़ुअल कैलकुलेटर कॉन्फ़िगर नहीं है: {reason}',
    'ms-MY': 'Kalkulator visual tidak dikonfigurasikan: {reason}',
  },
  'calculatorExplorer.rejected': {
    'fr-CA': 'Le calculateur visuel est indisponible\u00A0: {reason}',
    'de-DE': 'Der visuelle Rechner ist nicht verfügbar: {reason}',
    'hi-IN': 'विज़ुअल कैलकुलेटर अनुपलब्ध है: {reason}',
    'ms-MY': 'Kalkulator visual tidak tersedia: {reason}',
  },
  'guidedTrail.action': {
    'fr-CA': 'Parcours d\'apprentissage des monolithes',
    'de-DE': 'Monolith-Lernpfad',
    'hi-IN': 'मोनोलिथ लर्निंग ट्रेल',
    'ms-MY': 'Jejak Pembelajaran Monolit',
  },
  'guidedTrail.label': {
    'fr-CA': 'Parcours d\'apprentissage des monolithes',
    'de-DE': 'Monolith-Lernpfad',
  ...
  'guidedTrail.subtitle': {
    'fr-CA': 'Itinéraire lié à la source à travers des cas publiés\u00A0: navigation en lecture seule sur les nœuds existants.',
    'de-DE': 'Quellengebundene Route durch veröffentlichte Fälle: schreibgeschützte Navigation über vorhandene Knoten.',
    'hi-IN': 'प्रकाशित मामलों के माध्यम से स्रोत-बद्ध मार्ग: मौजूदा नोड्स पर केवल-पठन नेविगेशन।',
    'ms-MY': 'Laluan terikat sumber melalui kes yang diterbitkan: navigasi baca sahaja merentas nod sedia ada.',
  },
  'guidedTrail.close': {
    'fr-CA': 'Fermer le parcours d\'apprentissage',
    'de-DE': 'Lernpfad schließen',
    'hi-IN': 'लर्निंग ट्रेल बंद करें',
    'ms-MY': 'Tutup jejak pembelajaran',
  },
  'guidedTrail.educationalDisclosure': {
    'fr-CA': 'Cet itinéraire est une navigation pédagogique liée à la source\u00A0: il n\'exécute pas de calculateur, ne crée pas de résultat Core/Lean, de preuve, de confiance, d\'état ou de décision d\'autorité, et n\'effectue aucune action externe.',
    'de-DE': 'Diese Route ist eine quellengebundene Lernnavigation: Sie führt keinen Rechner aus, erstellt kein Core/Lean-Ergebnis, keinen Beweis, keine Vertrauensentscheidung, keinen Status und führt keine externe Aktion aus.',
    'hi-IN': 'यह मार्ग स्रोत-बद्ध शैक्षिक नेविगेशन है: यह कैलकुलेटर नहीं चलाता, Core/Lean परिणाम, प्रमाण, विश्वास, स्थिति या प्राधिकरण निर्णय नहीं बनाता, और कोई बाहरी कार्रवाई नहीं करता।',
    'ms-MY': 'Laluan ini ialah navigasi pembelajaran terikat sumber: ia tidak menjalankan kalkulator, tidak mencipta keputusan Core/Lean, bukti, kepercayaan, status atau keputusan autoriti, dan tidak melakukan tindakan luaran.',
  },
  'guidedTrail.initialAnchor': {
    'fr-CA': 'Point de départ de l\'apprentissage',
    'de-DE': 'Lernausgangspunkt',
    'hi-IN': 'सीखने का प्रारंभिक बिंदु',
    'ms-MY': 'Titik permulaan pembelajaran',
  },
  'guidedTrail.semanticIndex': {
    'fr-CA': 'Index sémantique',
    'de-DE': 'Semantischer Index',
    'hi-IN': 'सैमांटिक इंडेक्स',
    'ms-MY': 'Indeks semantik',
  },
  'guidedTrail.structuralResult': {
    'fr-CA': 'Résultat structurel',
    'de-DE': 'Strukturelles Ergebnis',
    'hi-IN': 'संरचनात्मक परिणाम',
    'ms-MY': 'Keputusan struktur',
  },
  'guidedTrail.open': {
    'fr-CA': 'Ouvrir {title}',
    'de-DE': '{title} öffnen',
  ...
  'guidedTrail.follow': {
    'fr-CA': 'Suivre vers {title}',
    'de-DE': 'Weiter zu {title}',
