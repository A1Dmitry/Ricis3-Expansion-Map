...
export const AVAILABLE_GEMINI_MODELS: readonly IAiModelOption[] = [
  { id: 'gemini-3.8-flash', name: 'Gemini 3.8 Flash (Default / High Speed)', category: 'flash', isDefault: true, isFast: true },
  { id: 'gemini-3.8-pro', name: 'Gemini 3.8 Pro (Next-Gen Reasoning)', category: 'pro' },
  { id: 'gemini-3.7-flash', name: 'Gemini 3.7 Flash', category: 'flash', isFast: true },
  { id: 'gemini-3.7-pro', name: 'Gemini 3.7 Pro (Math Verified)', category: 'pro' },
  { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', category: 'flash', isFast: true },
  { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro (Formal Verification)', category: 'pro' },
