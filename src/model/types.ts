...
export interface ProblemNode {
  ...
  leanWarnings?: string[];
  /**
   * Внешняя (открытая) математическая задача, к которой узел исторически привязан,
   * но о которой сам узел НЕ делает проверенного утверждения (F-05 / TASK-05).
   * Ссылка на внешнюю задачу живёт ТОЛЬКО здесь и обязана начинаться с пометки
