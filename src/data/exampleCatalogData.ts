...
export const RICIS_EXAMPLE_CATALOG: ReadonlyArray<IRicisCatalogExample> = [
  ...
  { id: 'L42', title: 'Exact SP5 Structural Resolution', input: 'x => (x - sin(x)) / pow(x, 3)', category: 'singularity_zero_zero', singularityPoint: 0, expectedNumeric: 0, description: 'Under pure SP5 trig pre-normalization, this resolves exactly to 0.' },
  { id: 'L43', title: 'Hyperbolic SP5 Resolution', input: 'x => (sinh(x) - x) / pow(x, 3)', category: 'singularity_zero_zero', singularityPoint: 0, expectedNumeric: 0, description: 'Resolves exactly to 0 without Taylor approximation.' },
