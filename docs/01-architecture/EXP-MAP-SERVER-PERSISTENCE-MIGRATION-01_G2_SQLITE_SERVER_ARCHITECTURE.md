...
**Parent decision:** `EXP-MAP-SERVER-PERSISTENCE-MIGRATION-01_G1_DECISION_2026-08-27.md` (external continuity record; файл находился во внешней рабочей директории `ricis_review/` вне дерева репозитория, поэтому ссылка приведена как текст)
