...
- ожидает прогона: `RicisAgiTarget` · job `mathlib-kernel-check` · статус PENDING_KERNEL_RUN
- ожидает прогона: `Schwarzschild_GeometricBridge` · job `kernel-check` · статус PENDING_KERNEL_RUN
